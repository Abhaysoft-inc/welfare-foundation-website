        ...
        return (
            <div className="p-8 text-center">
                ...
                <p className="text-gray-600 mb-6">
                    Your generous contribution of {formattedAmount} will help us make a difference.
                </p>
                ...
                <div className="bg-gray-50 rounded-lg p-4 mb-8 mx-auto max-w-sm border border-gray-200">
                    ...
                    <div className="flex justify-between py-2 border-b border-dashed border-gray-300">
                        ...
                        <span className="font-medium">{donorData.paymentType === 'one-time' ? 'One-time Donation' : 'Monthly Donation'}</span>
                    </div>
                    <div className="flex justify-between py-2">
                        <span className="text-gray-600">Receipt:</span>
                        <span className="font-medium text-orange-600">PSWF-{Math.random().toString(36).substring(2, 8).toUpperCase()}</span>
                    </div>
                </div>
                ...
                <div className="text-center space-y-4">
                    ...
                    <div className="pt-4 flex items-center justify-center space-x-3">
                        <button
                            onClick={() => {
                                // Create donation object with relevant data
                                const donation = {
                                ...
                                // Create a new instance of DonationCertificate in a hidden div and trigger its print method

...
export default function RegisterPage() {
    ...
    const handleFormSubmit = (data) => {
        setMemberData(data);
        setOtpTarget(data.email || data.mobile);
        setStep(2);
    };
            ...
            <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
                <div className={step === 3 ? "max-w-4xl mx-auto px-4 py-12" : "max-w-2xl mx-auto px-4 py-12"}>
                    ...
                    <div className="bg-white shadow-xl rounded-lg border border-orange-100">
                        ...
                        {step === 2 && (
                            <OtpVerification target={otpTarget} onVerified={handleOtpVerified} />
                        )}
                        {step === 3 && (
                            <>
                                ...
                                <div className="p-6 text-center border-t border-gray-200">
                                    <a href="/" className="inline-block px-6 py-3 rounded bg-gray-600 text-white font-medium hover:bg-gray-700 mr-4">
                                        Return to Homepage
                                    </a>
                                </div>
                            </>
